<div id="page-content" class="banner_header">
    <!--Page Title-->
    <div class="page section-header text-center" style="margin-top: 6%;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
                <div class="text-center mb-4">
                    <h2 class="h2">Dalaga Leather Manufacturing</h2>
        ...
        <div class="row">
            <div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img class="blur-up lazyload" data-src="<?php echo base_url() ?>assets/images/about1.jpg" src="<?php echo base_url() ?>assets/images/about1.jpg" alt="About Us" /></div>
            <div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img class="blur-up lazyload" data-src="<?php echo base_url() ?>assets/images/about2.jpg" src="<?php echo base_url() ?>assets/images/about2.jpg" alt="About Us" /></div>
            <div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4"><img class="blur-up lazyload" data-src="<?php echo base_url() ?>assets/images/about3.jpg" src="<?php echo base_url() ?>assets/images/about3.jpg" alt="About Us" /></div>
        </div>
        <div class="row">
            <div class="col-12">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                ...
                <ul class="addressFooter">
                    <li><i class="icon anm anm-map-marker-al"></i><p>Cameroon Street, Addis Ababa, Ethiopia</p></li>
                    <li class="phone"><i class="icon anm anm-phone-s"></i><p>(+251) 9 123 456 789</p></li>
                    <li class="email"><i class="icon anm anm-envelope-l"></i><p>sales@dalgaleather.com</p></li>
                </ul>
                <hr />

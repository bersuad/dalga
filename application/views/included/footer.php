                            ...
                            <div class="display-table">
                                <div class="display-table-cell footer-newsletter">
                                    <div class="section-header text-center">
                                        <label class="h2"><span>Keep in touch </span>on our social media link</label>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="site-footer">
            <div class="container">
                ...
                <div class="footer-top">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                            ...
                            <ul>
                                <li><a href="#"><i class="fa fa-phone"></i> +251 9 123-456-789</a></li>
                                <li><a href="#"><i class="fa fa-phone"></i> +251 9 123-456-789</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="footer-bottom">
                    <div class="row">
                        <!--Footer Copyright-->
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 copyright text-center"><span></span> <a href="<?php echo base_url('/') ?>">Dalga Leather.</a> <p>&copy; <?php echo date('Y') ?> All rights reserved.</p></div>
